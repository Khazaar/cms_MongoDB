...
export class ErrorService implements IErrorService {
    ...
    private initializeErrors() {
        ...
        this._error[AppError.RequiredFieldsNotProvided] = {
            key: AppError.RequiredFieldsNotProvided,
            code: 105,
        ...
        this._error[AppError.UniqueFieldsCollision] = {
            key: AppError.UniqueFieldsCollision,
            code: 105,
            message: "Unique fields collision",
        };
    }
}
