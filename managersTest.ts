import { submitTask, takeTask } from "./src/manager/team.manager";
...
// takeTask(authToken, "Simple server-side application", [
//     "Prtp 1",
//     "Prtp 2",
//     "Prtp 3",
// ]);

submitTask(authToken, "Simple server-side application");
